...
const InputTextSend = ({ name, id, placeholder }) => {
  return (
    <form className="w-full flex items-center fixed bottom-4 md:pl-80 px-4 z-20">
      {/* Input Message */}
      <input
        type="text"
        name={name}
        ...
        required
        className="form-input rounded-none bg-gray2 placeholder:text-font-gray text-font-white border-none  focus:ring-0 w-[90%] md:w-full h-12 rounded-l-md"
      />
